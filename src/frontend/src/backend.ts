...
export class Backend implements backendInterface {
    ...
    async addProduct(arg0: string, arg1: string, arg2: string, arg3: string, arg4: boolean): Promise<void> {
        if (this.processError) {
            try {
    ...
    async getContactInquiries(): Promise<Array<Inquiry>> {
        if (this.processError) {
            try {
    ...
    async isProductAvailable(arg0: bigint): Promise<boolean> {
        if (this.processError) {
            try {
                const result = await this.actor.isProductAvailable(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async placeOrder(arg0: string, arg1: string, arg2: string, arg3: Array<OrderItem>): Promise<void> {
        if (this.processError) {
            try {
    ...
    async updateProduct(arg0: bigint, arg1: string, arg2: string, arg3: string, arg4: string, arg5: boolean): Promise<void> {
        if (this.processError) {
            try {
